...
class SignupWithInvalidemail(unittest.TestCase):
    def setUp(self):
    ...
    def test_signup_with_invalidemail(self):
        driver = self.driver
        ...
        driver.find_element_by_id("id_username").clear()
        driver.find_element_by_id("id_username").send_keys("mithun")
        driver.find_element_by_id("id_email").clear()
        driver.find_element_by_id("id_email").send_keys("invalidemail@xyz.com")
        driver.find_element_by_id("id_password2").clear()
        driver.find_element_by_id("id_password2").send_keys("12345")
        driver.find_element_by_css_selector("input.btn.btn-primary").click()
        driver.find_element_by_css_selector("input.btn.btn-primary").click()
        ...
        driver.find_element_by_name("username").send_keys("mithun")
